...
// ========================================================================
// CORS & ORIGIN VALIDATION (FIXED FOR BRANCH DEPLOYS)
// ========================================================================
...
function isOriginAllowed(event) {
  ...
  // FIXED: Accept both production and branch deploy origins
  if (!allowedOrigin) {
    console.warn('⚠️  ALLOWED_ORIGIN not set - allowing all origins');
    return true;
  }
